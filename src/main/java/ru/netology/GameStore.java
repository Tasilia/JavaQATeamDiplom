...
public class GameStore {
    private List<ru.netology.Game> games = new ArrayList<>();
     ...
     */
    public ru.netology.Game publishGame(String title, String genre) {
        ru.netology.Game game = new ru.netology.Game(title, genre, this);
        games.add(game);
        return game;
    }
     ...
     */
    public boolean containsGame(ru.netology.Game game) {
